...
from  myMetroProcessing import processOneMetroImage, draw_rectangle, load_models
...
load_models()  # Load models only once
for n_val in range(num_images):
    ...
    BD.extend(bd.tolist())
    print(f"Recognition for {nom} done, found {len(bd)} symbols.")
